...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // const sanitizedUsernameOrEmail = usernameOrEmail;
  // const sanitizedPassword = password;
  if(sanitizedUsernameOrEmail!== usernameOrEmail || sanitizedPassword !== password){
    throw new apiError(400, "Attack Detected");
  }
