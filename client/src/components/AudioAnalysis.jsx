...
const AudioRecorder = () => {
    ...
    const uniqueEmotions = ["angry", "disgust", "fear", "happy", "neutral", "sad", "surprise"];
...
const options = {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-blue-700 px-6 py-16">
            ...
            <div className="bg-blue-400 rounded-xl p-8 shadow-lg text-center w-full max-w-lg">
                ...
                {blobURL && (
                    <div className="mt-6">
                        <h3 className="text-white text-lg font-medium">Recorded Audio:</h3>
                ...
                {emotions.length > 0 && (
                    <h3 className="mt-6 text-lg font-medium text-white">
                        <span className="text-gray-300">Predicted Emotions:</span> {emotions.join(", ")}
                    </h3>
                )}
